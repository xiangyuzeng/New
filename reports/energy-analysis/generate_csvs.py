...
STORES = [
    ...
    },
    {
        ...
        "match_confidence": "POSSIBLE — ConEd addr 200 E 21st St vs DB 261 3rd Ave (~1 block, same intersection)",
        "scene_type": "5",
    },
    {
    ...
    },
    {
        ...
        "match_confidence": "POSSIBLE — ConEd 125 W 31st vs DB 128 W 32nd (~1 block apart, Penn Station area)",
        "scene_type": None,
    },
    {
        "label": "S07", "coned_account": "11688453528", "coned_address": "184 Thompson St",
        "dept_id": None, "shop_no": None, "store_name": "UNMATCHED",
        "db_address": "NO MATCH IN DATABASE",
        "lat": None, "lon": None,
        "status": "unknown", "open_date": None,
        "neighborhood": "Greenwich Village (estimated)",
        "match_confidence": "NO MATCH — nearest: US00010 '154 Bleecker' (status=2, ~2 blocks away)",
        "scene_type": None,
    },
    {
